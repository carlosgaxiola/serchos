...
MySQL - 5.6.39 : Database - lavanderia
*********************************************************************
*/
...
insert  into `clientes`(`id`,`nombre`,`domicilio`,`telefono`,`id_usuario`,`f_registro`,`status`) values 
(1,'carlos','santa rosa de lima #20517 fracc. santa teresa','1234567890',1,'2019-03-28',1);
...
insert  into `detalle_recibos`(`id`,`id_servicio`,`id_recibo`,`cantidad`,`costo`) values 
(1,1,6,1,10);
...
insert  into `modulos`(`id`,`nombre`,`descripcion`,`ruta`,`fa_icono`,`id_padre`,`f_registro`,`status`) values 
(1,'Inicio','Modulos de inicio','inicio','fas fa fa-home',0,'2019-03-10',1),
(11,'Perfiles','Modulo que almacena los tipos de usuarios (Perfiles) del sistema','administrar/perfiles','fas fa fa-users-cog',0,'2019-03-09',1),
(12,'Modulos','Modulo de modulos','administrar/modulos','fas fa fa-database',0,'2019-03-09',1),
(13,'Clientes','Agregar, editar, eliminar y visualizar clientes','administrar/clientes','fas fa fa-user',0,'2019-03-09',1),
(14,'Servicios','Modulo encargado de los servicios de la lavanderia','administrar/servicios','fas fa fa-tags',0,'2019-03-09',1),
(15,'Cortesias','Las cortesias se dan a los clientes por un determinado numero de recibos','administrar/cortesias','fas fa fa-gift',0,'2019-03-09',1),
(16,'Contratos','Gestionar la informacion de los contratos de los empleados','administrar/contratos','0',0,'2019-03-09',1),
(17,'Recibos','Agregar, editar, alternar y visualizar recibos.','administrar/recibos','fas fa fa-files-o',0,'2019-03-09',1),
(18,'Usuarios','Agrega, edita, elimina y visualiza usuarios','administrar/usuarios','fas fa fa-users',0,'2019-03-10',1);
...
insert  into `perfiles`(`id`,`nombre`,`descripcion`,`status`,`f_registro`) values 
(1,'Desarrollador','Tiene permiso para editar modulos importantes para la integridad del sistema',1,'2019-03-09'),
(2,'Encargado','Acceso a modulos de servicios, cortesias, clientes, contratos y recibos',1,'2019-03-09'),
(3,'Usuario comun','Modulos de clientes, servicios y cortesias',1,'2019-03-09');
...
insert  into `perfiles_modulos`(`id`,`id_perfil`,`id_modulo`) values 
(36,2,13),
(37,2,14),
(38,2,15),
(39,2,16),
...
insert  into `recibos`(`id`,`f_recibo`,`id_cliente`,`total`,`observaciones`,`f_registro`,`id_usuario`,`status`) values 
(1,'2019-03-28',1,0,'prueba add 1','2019-03-28',1,1),
(2,'2019-03-28',1,0,'prueba add 2','2019-03-28',1,1),
(3,'2019-03-28',1,0,'prueba add 3','2019-03-28',1,1),
(4,'2019-03-28',1,0,'prueba add 3','2019-03-28',1,1),
(5,'2019-03-28',1,NULL,'prueba add 3','2019-03-28',1,1),
(6,'2019-03-28',1,10,'prueba add 3','2019-03-28',1,1);
...
insert  into `servicios`(`id`,`nombre`,`costo`,`id_usuario`,`f_registro`,`status`) values 
(1,'Edredon',10,1,'2019-03-28',1),
(2,'Colcha',20,1,'2019-03-28',1);
...
insert  into `usuarios`(`id`,`nombre`,`contraseña`,`id_perfil`,`f_registro`,`id_usuario`,`status`) values 
(1,'admin','40dc6c3b5c6595384395164908da32c18ae9dfc9',1,'2019-03-10',1,1),
(2,'carlos','8c31b65bdecdc9f18b695d7318186fd1feed690d',3,'2019-03-10',1,1),
(3,'encargado','29bd54d8d1e9bec6aaaaf7f987478bf8ce693b2b',2,'2019-03-10',1,1),
(5,'usuario','032cc0d6275931b2663a9c3302d7bcb46e515a04',3,'2019-03-10',1,0),
(6,'prueba','b23c7e733ee2599149724c9ea8bc3d0a096c3aa2',1,'2019-03-10',1,0),
(7,'prueba2','8c31b65bdecdc9f18b695d7318186fd1feed690d',1,'2019-03-10',1,0);

/*Table structure for table `lista_recibos` */

DROP TABLE IF EXISTS `lista_recibos`;

/*!50001 DROP VIEW IF EXISTS `lista_recibos` */;
/*!50001 DROP TABLE IF EXISTS `lista_recibos` */;

/*!50001 CREATE TABLE  `lista_recibos`(
 `id` int(11) ,
 `f_recibo` date ,
 `id_cliente` int(11) ,
 `total` float ,
...
/*Table structure for table `listar_detalle_recibos` */

DROP TABLE IF EXISTS `listar_detalle_recibos`;

/*!50001 DROP VIEW IF EXISTS `listar_detalle_recibos` */;
/*!50001 DROP TABLE IF EXISTS `listar_detalle_recibos` */;

/*!50001 CREATE TABLE  `listar_detalle_recibos`(
 `id` int(11) ,
 `id_servicio` int(11) ,
 `id_recibo` int(11) ,
 `cantidad` int(11) ,
