...
CREATE TABLE `cortesias` (
  ...
  `cantidad` int(11) NOT NULL COMMENT 'Cantidad de recibos acumulados por el cliente',
  ...
  `id_usuario` int(11) NOT NULL COMMENT 'Usuario que hizo el registro',
  `f_registro` date DEFAULT NULL COMMENT 'Fecha de registro',
  `status` int(11) DEFAULT NULL COMMENT 'Estado del registro (0 Inactivo, 1 Activo, 2 Terminada)',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=latin1;

/*Data for the table `cortesias` */

insert  into `cortesias`(`id`,`id_cliente`,`cantidad`,`f_inicio`,`periodo`,`id_usuario`,`f_registro`,`status`) values (3,3,3,'2019-04-11',2019,1,'2019-04-11',1);

/*Table structure for table `detalle_cortesias` */

DROP TABLE IF EXISTS `detalle_cortesias`;

CREATE TABLE `detalle_cortesias` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Id del registro',
  `id_recibo` int(11) NOT NULL COMMENT 'Identificador del servicio incluido en la cortesia',
  `id_cortesia` int(11) NOT NULL COMMENT 'Identificador de la cortesia incluida en el servicio',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=latin1;

/*Data for the table `detalle_cortesias` */

insert  into `detalle_cortesias`(`id`,`id_recibo`,`id_cortesia`) values (1,4,3),(5,8,3),(6,9,3);
...
insert  into `detalle_recibos`(`id`,`id_servicio`,`id_recibo`,`cantidad`,`costo`) values (7,1,4,2,26),(8,2,4,1,80),(12,1,8,1,26),(13,1,9,1,26);
...
insert  into `recibos`(`id`,`f_recibo`,`id_cliente`,`total`,`observaciones`,`f_registro`,`id_usuario`,`status`) values (4,'2019-04-11',3,132,'ninguna','2019-04-11',1,1),(8,'2019-04-12',3,26,'nada','2019-04-12',1,1),(9,'2019-04-12',3,26,'nada','2019-04-12',1,1);
